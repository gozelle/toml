...
work):
    ...
    $ git clone https://github.com/gozelle/toml-test.git
    $ cd toml-test
    $ go build ./cmd/toml-test

This will build a `./toml-test` binary.

[r]: https://github.com/gozelle/toml-test/releases
...
For example, to run the tests against the Go TOML library:
    ...
    # Install my parser
    $ go install github.com/gozelle/toml/cmd/toml-test-decoder@master
    $ go install github.com/gozelle/toml/cmd/toml-test-encoder@master
...
- [Add tags](https://github.com/gozelle/toml/blob/master/internal/tag/add.go)
- [Remove tags](https://github.com/gozelle/toml/blob/master/internal/tag/rm.go)
...
- When testing encoders, the TOML decoder at
  [BurntSushi/toml](https://github.com/gozelle/toml) is assumed to be 
